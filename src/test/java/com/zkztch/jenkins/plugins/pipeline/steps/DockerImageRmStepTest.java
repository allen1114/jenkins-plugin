...
@Slf4j
public class DockerImageRmStepTest {
    ...
    public void lsByReference() throws Exception {
        String format = "pipeline {\n" +
                ...
                "            steps {\n" +
                "               script {\n" +
                "                   dockerImageRm image:'%s', dockerHost:'%s', dockerCertPath:'%s', registryUrl:'%s', registryUsername:'%s', registryPassword:'%s'\n" +
                "               }\n" +
                "            }\n" +
                "        }\n" +
                "    }\n" +
