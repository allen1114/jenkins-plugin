...
@Slf4j
public class GitlabGetCommitFieldStepTest {
    ...
    public void test() throws Exception {
        ...
        String script = String.format(
                "def message = gitlabGetCommitField host: '%s', token: '%s', namespace: '%s', project: '%s', commit: '%s', field: 'message'  \n" +
                        "echo message",
        ...
        jenkinsRule.assertLogContains(commit.getMessage(), jenkinsRule.assertBuildStatusSuccess(job.scheduleBuild2(0)));
